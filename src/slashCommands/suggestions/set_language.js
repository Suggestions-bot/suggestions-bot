...
module.exports = {
  ...
  options: [
    ...
    {"StringChoices": { name: "language", description: "Select your prefered Language", required: true, choices: [["English", "lang_en"], ["German", "lang_de"], ["Russian", "lang_ru"], ["Spanish", "lang_es"]] }}

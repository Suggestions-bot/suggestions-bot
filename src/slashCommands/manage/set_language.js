...
module.exports = {
  ...
  options: [
    ...
    {"StringChoices": { name: "language", description: "Select your prefered Language", required: true, choices: [["English", "lang_en"], ["German", "lang_de"], ["Dutch", "lang_nl"], ["Russian", "lang_ru"], ["Spanish", "lang_es"]] }}

...
function onCoolDown(message, command) {
  ...
  function shuffle(array) {
    try {
      ...
      Logger.error(`Error whilst doing Math`, e)
    }
  }
  ...
  function formatDate(date) {
    try {
      ...
      Logger.error(`Error whilst getting Date and Time`, e)
      return false;
    }
  }
  ...
  function delay(delayInms) {
    try {
      ...
      Logger.error(`Error whilst delaying`, e)
    }
  }
  ...
  function getRandomInt(max) {
    try {
      ...
      Logger.error(`Error whilst getting Random Int`, e)
    }
  }
  ...
  function getRandomNum(min, max) {
    try {
      ...
      Logger.error(`Error whilst getting Random Float`, e)
    }
  }
  ...
  function createBar(total, current, size = 25, line = "▬", slider = "🔷") {
    try {
      ...
      Logger.error(`Error whilst creating Bar`, e)
    }
  }
  ...
  function format(millis) {
    try {
      ...
      Logger.error(`Error whilst formatting Time`, e)
    }
  }
  ...
  function escapeRegex(str) {
    try {
      ...
      Logger.error(`Error whilst escaping Regex`, e)
    }
  }
  ...
  function arrayMove(array, from, to) {
    try {
      ...
      Logger.error(`Error whilst moving Array`, e)
    }
  }
   ...
   */
   ...
   async function swap_pages(client, message, description, TITLE) {
     ...
     .setFooter(ee.footertext, ee.footericon)]}).catch(e => Logger.super_error("YAC - Module of YSH prevented following crash:", e))
     ...
     collector.on('collect', async b => {
         if(b.user.id !== message.author.id)
           return b.reply(`${emojis.sign_deny} **Only the one who typed ${prefix}help is allowed to react!**`, true)
           //page forward
           if(b.customId == "1") {
  ...
  function change_status(client) {
    try {
      ...
      Logger.error(`Error whilst setting the Activity`, e);
    }
  }

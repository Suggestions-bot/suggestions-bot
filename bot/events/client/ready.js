...
module.exports = client => {
    ...
    try {
        try {
            ...
            Logger.chunkmessage(`     ┃ ` + `Guilds: ${client.guilds.cache.size}` + " ".repeat(-1 + stringlength - ` ┃ `.length - `Guilds: ${client.guilds.cache.size}`.length) + "┃")
            Logger.chunkmessage(`     ┃ ` + `Users: ${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)}` + " ".repeat(-1 + stringlength - ` ┃ `.length - `Users: ${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)}`.length) + "┃")
            Logger.chunkmessage(`     ┃ ` + " ".repeat(-1 + stringlength - ` ┃ `.length) + "┃")
            Logger.chunkmessage(`     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`)
            Logger.chunkmessage("")
        } catch {

...
module.exports = {
  ...
  description:
    'Gets the top X most upvoted suggestions that have not been accepted/declined.', //the command description for Slash Command Overview
  ...
  run: async (client, interaction) => {
    try {
      ...
      let udata = await db.getServerSuggestionsSortedByUpvotes(

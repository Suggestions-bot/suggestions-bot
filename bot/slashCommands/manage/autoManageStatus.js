...
module.exports = {
    ...
    options: [
        ...
        {"Integer": {name: "accept_amount", description: "The amount of upvotes a suggestion needs to be accepted automatically", required: false}},
        {"Integer": {name: "decline_amount", description: "The amount of downvotes a suggestion needs to be declined automatically", required: false}},
        {
            "StringChoices": {
                name: "reset",
    ...
    run: async (client, interaction) => {
        try {
            ...
            if (accept_amount != null && decline_amount != null) {
                ...
                interaction.reply({content: lang.set_auto_accept.replace(/{amount}/g, accept_amount) + "\n" + lang.set_auto_decline.replace(/{amount}/g, decline_amount), ephemeral: true});
                accept_amount = null
                decline_amount = null
            }

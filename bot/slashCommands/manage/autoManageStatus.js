  ...
  options: [
    {
      Integer: {
        name: 'accept_amount',
        description:
          'The amount of upvotes a suggestion needs to be accepted automatically',
        required: false,
      },
    },
    {
      Integer: {
        name: 'decline_amount',
        description:
          'The amount of downvotes a suggestion needs to be declined automatically',
        required: false,
      },
    },
    {
    ...
    try {
      ...
      if (remove === 'true') {
        try {
          ...
          interaction.reply({ content: lang.reset_auto, ephemeral: true })
        } catch (e) {
          interaction.reply({ content: lang.reset_auto_error, ephemeral: true })
        }
      }
      ...
      if (accept_amount != null && decline_amount != null) {
        ...
        interaction.reply({
          content:
            lang.set_auto_accept.replace(/{amount}/g, accept_amount) +
            '\n' +
      ...
      if (decline_amount != null) {
        await db.setServerAutoDecline(interaction.guild?.id, decline_amount)
        interaction.reply({
          content: lang.set_auto_decline.replace(/{amount}/g, decline_amount),
          ephemeral: true,
        })
      }
    } catch (e) {

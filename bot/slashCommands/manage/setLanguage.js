...
module.exports = {
  ...
  description:
    'Set the language that the bot uses to communitate with you. (Commands stay in English)', //the command description for Slash Command Overview
  ...
  run: async (client, interaction) => {
    try {
      ...
      interaction.reply({ content: lang.change_language, ephemeral: true })
    } catch (e) {

...
module.exports = {
  ...
  description:
    'Change the looks of the embed. Execute with no options to reset.', //the command description for Slash Command Overview
  ...
  options: [
    {
      String: {
        name: 'color',
        description:
          'The color you want the embed to be. (has to be hex e.g. #2c2f33)',
        required: false,
      },
    },
    {
    ...
    },
    {
      String: {
        name: 'icon_accepted',
        description: 'The default is a checkmark',
        required: false,
      },
    },
    {
      String: {
        name: 'icon_declined',
        description: 'The default is a cross',
        required: false,
      },
    },
  ],
  run: async (client, interaction) => {
    try {
      ...
      if (gcolor != null) {
        ...
        if (gcolor.length !== 6) {
          interaction.reply({
            content: lang.embed_invalid_color,
            ephemeral: true,
          })
          return
        }
      ...
      await db.setServerEmbedSettings(
      ...
      interaction.reply({ content: lang.embed_success, ephemeral: true })
    } catch (e) {
